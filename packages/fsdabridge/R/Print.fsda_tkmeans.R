#' Print method for fsda_tkmeans objects
#'
#' Displays a summary of a \code{\link{fsda_tkmeans}} result: observation and
...
#'
#' @param x An object of class \code{"fsda_tkmeans"}.
#' @param ... Further arguments passed to or from other methods (unused).
#'
#' @return Invisibly returns \code{x}.
#' @export
print.fsda_tkmeans <- function(x, ...) {
    cat("\n")
    cat("FSDA TKMEANS\n")
    cat("============\n\n")
